...
#define MASK_ESP32_ALWAYS_MEMMARRIER (1U << 0)
#define MASK_AUTO_LITPOOLS (1U << 1)
#define MASK_CONST16 (1U << 2)
#define MASK_ESP32_PSRAM_FIX (1U << 3)
...
enum opt_code
{
  ...
  OPT_mforce_no_pic = 1194,                  /* -mforce-no-pic */
  /* OPT_mfused_madd = 1195, */              /* -mfused-madd */
  OPT_mlongcalls = 1196,                     /* -mlongcalls */
  OPT_mserialize_volatile = 1197,            /* -mserialize-volatile */
  OPT_mtarget_align = 1198,                  /* -mtarget-align */
  OPT_mtext_section_literals = 1199,         /* -mtext-section-literals */
  OPT_n = 1200,                              /* -n */
  ...
  OPT_static_pie = 1251,                     /* -static-pie */
  ...
  OPT_std_c__2a = 1259,                      /* -std=c++2a */
  OPT_std_c__98 = 1260,                      /* -std=c++98 */
  OPT_std_c11 = 1261,                        /* -std=c11 */
  OPT_std_c17 = 1262,                        /* -std=c17 */
  /* OPT_std_c18 = 1263, */                  /* -std=c18 */
  ...
  OPT_std_gnu__2a = 1282,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1283,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1284,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1285,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1286, */                /* -std=gnu18 */
  ...
  /* OPT_std_iso9899_2017 = 1297, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1298, */         /* -std=iso9899:2018 */
